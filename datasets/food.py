...
SPLITS_TO_SIZES = {'train': 905, 'validation': 200}
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  for f in file_lists:
    if f.find(split_name) >= 0:
      file_path = os.path.join(dataset_dir, f)
    try:
      file_pattern.append(file_path)
  ...
  items_to_handlers = {
      ...
      'categoryname': slim.tfexample_decoder.Tensor('image/categoryname'),
  }
